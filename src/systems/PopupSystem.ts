...
export class PopupSystem {
     ...
     * @private
     */
    private ensurePopupVisibility(customPopup: HTMLElement, x: number, y: number, offsetX: number, offsetY: number): void {
    ...
    createPopup(lat: number, lon: number, content: PopupContent, options: PopupOptions = {}): HTMLElement | null {
        try {
            ...
            this.ensurePopupVisibility(customPopup, screenPos.x, screenPos.y, offsetX, offsetY);
